    ...
    var b = function (b) {
        ...
        b = b || {}, "string" == typeof b && (b = {elements: b}), this.sel = null, this.textSelection = "", this.htmlSelection = "", this.appId = a('meta[property="fb:app_id"]').attr("content") || a('meta[property="fb:app_id"]').attr("value"), this.url2share = a('meta[property="og:url"]').attr("content") || a('meta[property="og:url"]').attr("value") || window.location.href, this.getSelectionText = function (a) {
            ...
            if (a = a || window.getSelection(), a.rangeCount) {
                for (var e = document.createElement("div"), f = 0,
                         g = a.rangeCount; g > f; ++f)e.appendChild(a.getRangeAt(f).cloneContents());
                d = e.textContent, b = e.innerHTML
            }
            return c.textSelection = d, c.htmlSelection = b || d, d
        }, this.selectionDirection = function (a) {
            var b = a || window.getSelection(), c = document.createRange();
            ...
            var a = window.getSelection(), b = c.getSelectionText(a);
            ...
            var d = a.getRangeAt(0), e = d.endContainer.parentNode;
            ...
            if (e.nextElementSibling) c.pushSiblings(e); else {
            ...
            if (a = a || function () {
                    }, "fixed" == c.popunder)return c.popunder.style.bottom = "-50px", a();
            ...
            setTimeout(function () {
                var b = window.getSelection(), d = c.getSelectionText(b);
                if (!b.isCollapsed && d && d.length > 10 && d.match(/ /)) {
                    var e = b.getRangeAt(0), f = e.getBoundingClientRect().top - 5,
                        g = f + c.getPosition().y - c.$popover.height(), h = 0;
                    if (a) h = a.pageX; else {
            ...
            var c = a.length > b, d = c ? a.substr(0, b - 1) : a;
            ...
            c && b.push(c);
            for (var d = document.getElementsByTagName("a"), e = 0,
                     f = d.length; f > e; e++)if (d[e].attributes.href && "string" == typeof d[e].attributes.href.value) {
            ...
            var e = 640, f = 440, g = screen.width / 2 - e / 2, h = screen.height / 2 - f / 2 - 100;
            ...
            var b = c.htmlSelection.replace(/<p[^>]*>/gi, "\n").replace(/<\/p>|  /gi, "").trim(),
                ...
                e = 640, f = 440, g = screen.width / 2 - e / 2, h = screen.height / 2 - f / 2 - 100;
