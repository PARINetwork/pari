...
(function (exports) {
    ...
    var generateSocialUrl = function generateSocialUrl(socialType, text) {
        ...
        if (parameters.twitterHashtag && parameters.twitterHashtag.length) {
            twitterUrl += '&hashtags=' + parameters.twitterHashtag;
        }

        var facebookUrl = 'https://facebook.com/sharer.php?u='+ PAGE_URL +'&quote=' + text ;
